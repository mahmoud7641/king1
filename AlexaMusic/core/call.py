    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**لم يتم إجاد محادثات صوتية نشطه**\n\nمن فضلك تأكد انك بدأت محادثة فيديو."
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                
                "**الحساب المساعد في محادثة الفيديو بالفعل**\n\nنظام بوت تشغيل القران وجد ان الحساب المساعد بالفعل في محادثة فيديو، اذا استمرت هذه المشكله قم بـإغلاق محادثة الفيديو و اعد المحاوله."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**خطأ في سيرفر التليجرام**\n\nمن فضلك اغلق محادثة الفيديو و اعد المحاولة."
            )
